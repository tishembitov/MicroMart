...
import ru.tishembitov.reviewsservice.dto.*;
...
import ru.tishembitov.reviewsservice.service.impl.ReviewServiceImpl;
...
class ReviewServiceImplTest {
    ...
    void addOne_WhenValidReview_ShouldSaveReview() {
        ...
        //Act
        var reviewCreated = this.reviewServiceImpl.addOne(this.reviewCreateDto);
    ...
    void addOne_WhenReviewAlreadyExists_ShouldThrowReviewException() {
        ...
        Assertions.assertThrows(
                ...
                () -> this.reviewServiceImpl.addOne(this.reviewCreateDto),
    ...
    void getAllByUser() {
        ...
        //Act
        var actualReviews = this.reviewServiceImpl.getAllByUser();
    ...
    void getAllByProduct_WhenSingleReview_ShouldReturnList() {
        ...
        //Act
        var actualReviews = this.reviewServiceImpl.getAllByProduct(anyLong());
    ...
    void deleteOne_WhenReviewExists_ShouldDeleteReview() {
        ...
        when(this.reviewRepository.deleteOneById(anyLong()))
                .thenReturn(1);
        //Act
        var hasDeleted = this.reviewServiceImpl.deleteOne(this.reviewDto.id());
    ...
    void getTopAvgRatedProducts() {
        ...
        //Act
        var actualTopRatedProducts = this.reviewServiceImpl.getTopAvgRatedProducts(5);
