package ru.tishembitov.apigateway;

import ru.tishembitov.apigateway.filters.AuthenticationPrefilter;
import ru.tishembitov.apigateway.filters.SwaggerFilter;
...
@Slf4j
@OpenAPIDefinition(info = @Info(title = "MicroMart API"))
